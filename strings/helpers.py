...
HELP_3 = """BROADCAST FEATURE [only for sudoers]:
...
HELP_4 = """CHAT BLACKLIST FEATURE [only for sudoers]:
...
HELP_5 = """BLOCK USERS: [only for sudoers]
...
/cplay : Starts streaming the requested audio track on channel's video chat.
/cvplay : Starts streaming the requested video track on channel's video chat.
...
HELP_7 = """GLOBAL BAN FEATURE [only for sudoers]:
...
HELP_9 = """MAINTENANCE MODE [only for sudoers]:
